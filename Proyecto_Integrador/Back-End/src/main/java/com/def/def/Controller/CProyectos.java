...
package com.def.def.Controller;

import com.def.def.Dto.dtoProyectos;
import com.def.def.Entity.Proyectos;
import com.def.def.Security.Controller.Mensaje;
import com.def.def.Service.SProyectos;
...
public class CProyectos {
    ...
    public ResponseEntity<?> create(@RequestBody dtoProyectos dtoproyectos){
        ...
        Proyectos proyectos = new Proyectos(
                dtoproyectos.getNombreP(), dtoproyectos.getDescripcionP(), dtoproyectos.getImg(), dtoproyectos.getLink()
            );
